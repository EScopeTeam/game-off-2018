...
!(function(factory) {
  ...
  var EventBus = function(url, options) {
    ...
    this.maxReconnectAttempts =
      options.vertxbus_reconnect_attempts_max || Infinity;
    ...
    var getReconnectDelay = function() {
      var ms =
        self.reconnectDelayMin *
        Math.pow(self.reconnectExponent, self.reconnectAttempts);
    ...
    var setupSockJSConnection = function() {
      ...
      self.sockJSConn.onclose = function(e) {
        ...
        if (
          ...
          self.reconnectTimerID = setTimeout(
